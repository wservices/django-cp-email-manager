...
ADMINS = (
    #("""Pascal Bader""", 'info@wservices.ch'),
)
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://tools@localhost/tools_email-manager'),
}
...
API_URL = env('API_URL', default='https://api.djangoeurope.com/')
API_KEY = env('API_KEY')
